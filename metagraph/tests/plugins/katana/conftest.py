...
from metagraph.plugins import has_katana
...
def kg_from_nx_di_8_12(networkx_weighted_directed_8_12):
    pg_test_case = mg.translate(
        networkx_weighted_directed_8_12, mg.wrappers.Graph.KatanaGraph
    )
    return pg_test_case
...
def kg_from_nx_ud_8_12(networkx_weighted_undirected_8_12):
    pg_test_case = mg.translate(
        networkx_weighted_undirected_8_12, mg.wrappers.Graph.KatanaGraph
    )
    return pg_test_case
