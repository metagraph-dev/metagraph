...
def test_edge_property(katanagraph_rmat15_cleaned_di):
    ...
    assert (
        katanagraph_rmat15_cleaned_di.value.get_edge_property("value").to_pandas()[0]
        == 339302416426
    )
...
def test_num_nodes_networkx(
    networkx_weighted_undirected_8_12, networkx_weighted_directed_8_12
):
